...
void main() {
  group('Firebase AI Logic Integration Tests', () {
    ...
    test('should demonstrate correct Firebase AI Logic initialization pattern', () async {
...
''';
    ...
    test('should validate GenerationConfig parameters', () async {
      ...
      expect(config.maxOutputTokens, equals(FirebaseAIConstants.maxOutputTokens));
