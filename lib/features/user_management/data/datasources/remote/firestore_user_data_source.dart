...
class FirestoreUserDataSourceImpl implements FirestoreUserDataSource {
  ...
  Future<void> updateUserProfile(UserModel user) async {
    try {
      ...
      throw const ServerException('Failed to update user profile');
    }
  }
  ...
  Future<void> deleteUserProfile(String userId) async {
    try {
      ...
      throw const ServerException('Failed to delete user profile');
    }
  }
  ...
  Future<void> updateUserPreferences(
    ...
    try {
      ...
      throw const ServerException('Failed to update user preferences');
    }
  }
  ...
  Future<UserModel?> getUserByEmail(String email) async {
    try {
      ...
      throw const ServerException('Failed to get user by email');
    }
  }
