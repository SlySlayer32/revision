...
class GeminiConstants {
  ...
  static const String promptTooLongError =
      'Prompt too long (max $maxPromptLength characters)';
  static const String imageEmptyError = 'Image bytes cannot be empty';
  static const String imageTooLargeError =
      'Image too large (max ${maxImageSizeBytes ~/ (1024 * 1024)}MB)';
  static const String invalidApiKeyFormatError = 'Invalid API key format';
  static const String connectivityTestFailedError =
